...
int init_logging()
{
 try
 {
  ...
  Node configObj = LoadFile("/home/lily/DriverStation-Lite/config/ds_config.yaml");
 ...
 catch (const YAML::BadFile& e)
 {
  ...
  XMLError result = configObj.LoadFile( "/home/lily/DriverStation-Lite/config/ds_config.xml" );
